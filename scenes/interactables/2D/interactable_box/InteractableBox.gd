...
@onready var interactable_2d: Area2D = $Interactable2D
...
func _on_interactable_2d_interacted(_interactor: Node2D) -> void:
	label.text = "Interacted with the box!"


func _on_interactable_2d_closest(_interactor: Node2D) -> void:
	label.text = "Closest to the box!"


func _on_interactable_2d_not_closest(_interactor: Node2D) -> void:
	label.text = "Not closest to the box!"


func _on_interactable_2d_focused(_interactor: Node2D) -> void:
	label.text = "Focused on the box!"


func _on_interactable_2d_unfocused(_interactor: Node2D) -> void:
