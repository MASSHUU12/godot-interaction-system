...
Instructions on how to get started can be found in the [USAGE.md](./addons/interaction_system/docs/USAGE.md) file.

You can find the documentation in the [docs](./addons/interaction_system/docs/) folder
