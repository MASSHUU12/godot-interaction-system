...
public partial class InteractionSystem : EditorPlugin
{
	public override void _EnterTree()
	{
		...
		script = GD.Load<Script>("res://addons/interaction_system/src/interactor/CharacterInteractor3D.cs");
		AddCustomType("CharacterInteractor3D", "Node3D", script, texture);

		script = GD.Load<Script>("res://addons/interaction_system/src/interactor/CharacterInteractor2D.cs");
