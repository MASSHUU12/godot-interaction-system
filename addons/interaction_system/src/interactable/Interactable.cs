...
public partial class Interactable : Node
{
	...
	[Signal] public delegate void LongInteractedStartedEventHandler(Interactor interactor);
	[Signal] public delegate void LongInteractedEventHandler(Interactor interactor);
	[Signal] public delegate void LongInteractedCancelledEventHandler(Interactor interactor);
