...
@onready var interactable_prop_3d: Area3D = $InteractableProp3D
...
func _on_interactable_prop_3d_interacted(_interactor: Node3D) -> void:
	label_3d.text = "Interacted with the box!"


func _on_interactable_prop_3d_closest(_interactor: Node3D) -> void:
	label_3d.text = "Closest to the box!"


func _on_interactable_prop_3d_not_closest(_interactor: Node3D) -> void:
	label_3d.text = "Not closest to the box!"


func _on_interactable_prop_3d_focused(_interactor: Node3D) -> void:
	label_3d.text = "Focused on the box!"


func _on_interactable_prop_3d_unfocused(_interactor: Node3D) -> void:
